...
export const aboutTranslations = {
  es: {
    ...
    surveyCityLabel: "Ciudad de servicio",
    surveyCityPlaceholder: "Seleccione una ciudad",
    surveySalespersonLabel: "Asesor comercial",
    surveySalespersonPlaceholder: "Seleccione el asesor que le atiende",
    surveySalespersonLoading: "Cargando asesores…",
    surveySalespersonNone: "No hay asesores configurados para esta ciudad. EsLatin gestionará la solicitud.",
    surveySalespersonRequired: "Seleccione el asesor comercial que le atiende.",
    surveySalespersonUnavailable: "No pudimos consultar los asesores. Inténtelo de nuevo.",
    ...
    surveyInviteGeneralInstruction: "Si no está vinculado a una marca asociada, escríbanos a info@eslatin.com.co para solicitar un código.",
    surveyInviteEmail: "Enviar correo a info@eslatin.com.co",
    ...
    surveySalespersonEmailConfirmed: "También enviamos la información al asesor comercial seleccionado.",
  ...
  zh: {
    ...
    surveyCityLabel: "服务城市",
    surveyCityPlaceholder: "请选择城市",
    surveySalespersonLabel: "车企销售顾问",
    surveySalespersonPlaceholder: "请选择负责您的销售顾问",
    surveySalespersonLoading: "正在加载销售顾问…",
    surveySalespersonNone: "该城市暂未配置销售顾问，EsLatin 将直接跟进此预约。",
    surveySalespersonRequired: "请选择负责您的销售顾问。",
    surveySalespersonUnavailable: "暂时无法查询销售顾问，请稍后重试。",
    ...
    surveyInviteGeneralInstruction: "如您并非合作车企关联用户，请发送邮件至 info@eslatin.com.co 申请邀请码。",
    surveyInviteEmail: "发送邮件至 info@eslatin.com.co",
    ...
    surveySalespersonEmailConfirmed: "预约信息也已发送给您选择的销售顾问。",
