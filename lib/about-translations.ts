...
export const aboutTranslations = {
  es: {
    ...
    heroSubtitle:
      "Somos un proveedor de infraestructura de carga EV enfocado en América Latina, conectando innovación global con ejecución local.",

    // Who We Are
    whoWeAreTitle: "Quiénes Somos",
    whoWeAreParagraph1:
      "EsLatin es una empresa de infraestructura de carga para vehículos eléctricos con presencia en América Latina. Nos especializamos en instalación profesional, venta de equipos y soluciones de plataforma de operación para redes de carga.",
    whoWeAreParagraph2:
    ...
    installationFocusDesc:
      "Servicios de instalación profesional para sitios residenciales, comerciales e industriales con técnicos certificados.",
    salesFocus: "Ventas",
    salesFocusDesc:
    ...
    supplyChainDesc:
      "Acceso directo a fabricantes en China y distribuidores en América Latina garantiza precios competitivos, entrega confiable y soporte técnico continuo.",
