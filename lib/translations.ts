...
export const translations = {
  es: {
    ...
    // Platform
    platformTitle: "Plataforma de Operación",
    platformDesc:
      "Plataforma de gestión basada en la nube para redes de carga. Monitoree, administre y monetice su infraestructura de carga con análisis en tiempo real.",
    platformFeature1: "Monitoreo y control en tiempo real",
    platformFeature2: "Integración de pagos y facturación",
  ...
  zh: {
    ...
    installationDesc:
      "为住宅和商业电动汽车充电站提供专业安装服务。在整个拉丁美洲提供由认证技术人员执行的交钥匙解决方案。",
    installationFeature1: "住宅和商业站点",
    installationFeature2: "快速和超快速充电器",
    installationFeature3: "全面合规和认证",

    // Sales
    salesTitle: "充电桩销售",
    salesDesc: "为经销商和最终用户提供高质量的电动汽车充电器。直接对接国际供应链，价格具有竞争力，交付可靠。",
    salesFeature1: "经销商和零售项目",
    salesFeature2: "中国和拉美供应",
    salesFeature3: "质保和技术支持",

    // Platform
    platformTitle: "运营平台",
    platformDesc: "基于云的充电网络管理平台。通过实时分析监控、管理和运营您的充电基础设施。",
    platformFeature1: "实时监控和控制",
    platformFeature2: "支付和计费集成",
    platformFeature3: "使用分析和报告",

    // Trust
    whyChoose: "为什么选择 EsLatin",
    complianceTitle: "全面合规",
    complianceDesc: "所有安装均符合国际安全标准和当地监管要求。认证设备和持证技术人员。",
    supplyChainTitle: "全球供应链",
    supplyChainDesc: "与中国制造商和拉丁美洲经销商的直接合作确保了有竞争力的价格和可靠的交付。",
    turnkeyTitle: "交钥匙交付",
    turnkeyDesc: "从现场评估到调试，我们处理每一步。安装、设备和持续支持的单一联系点。",
    ...
    ctaSubtitle: "加入电动革命，使用为拉丁美洲打造的可靠、可扩展的充电解决方案。",
